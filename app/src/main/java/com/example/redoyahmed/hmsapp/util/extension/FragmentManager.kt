package com.example.redoyahmed.hmsapp.util.extension
...
internal fun FragmentManager.addFragment(containerViewId: Int, fragment: Fragment, tag: String, slideIn: Int = R.anim.slide_left, slideOut: Int = R.anim.slide_right) {
